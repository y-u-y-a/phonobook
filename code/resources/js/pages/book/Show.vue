    ...
    <div class="col-md-10">
      ...
      <div class="row py-2 bg-white">
        <ul class="col-md-7 px-2">
          <li v-if="book.author!=undefined" class="mb-2">著者 ：{{ book.author }}</li>
          <li v-if="book.volume!=undefined" class="mb-2">巻 ：{{ book.volume }}</li>
          <li v-if="book.series!=undefined" class="mb-2">シリーズ ：{{ book.series }}</li>
          <li v-if="book.publisher!=undefined" class="mb-2">出版社 ：{{ book.publisher }}</li>
          <li v-if="book.pubdate!=undefined" class="mb-2">出版日 ：{{ book.pubdate }}</li>
          <li v-if="book.detail!=undefined" class="mb-2">{{ book.detail }}</li>
          <li>
            <FormRichButton
              v-if="book.state==0"
              @trigger="borrowBook({
